# PowerShell script to set up Excel Add-in Backend as a Windows service using NSSM
# Usage: .\setup-backend-service.ps1 -BackendPath "C:\inetpub\wwwroot\ExcelAddin\backend"
